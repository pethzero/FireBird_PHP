...
class SQLQueries
{
    ...
    public function __construct()
    {
        ...
        // $this->sqlsreach['IND_APPPOINTMENT'] = "INSERT INTO appointment (CREATED,LASTUPD,CUSTNAME,STATUS,DETAIL,REMARK,STARTD,WARND,OWNERNAME,ADDR) VALUES (NOW(),NOW(),:name,'A',:detail,:remark,:startd,:warmd,:ownername,:location)";
