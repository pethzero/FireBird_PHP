...
try {
 ...
 //////////////////////////////////////////// START HEAD DATA //////////////////////////////////////////////////////////////
  ...
  /////////////// MYSQL
  // $query = "SELECT AUTO_INCREMENT FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'san' AND TABLE_NAME = 'activityhd'";
  $query = "SELECT AUTO_INCREMENT FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'SAN' AND TABLE_NAME = 'activityhd'"; // SERVER
  ...
  $docno = "66" . "/" . sprintf("%04d", $autoIncrementValue);
