            ...
            <div class="col-md-12">
              <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  <section>
                    <h3><b>ใบรับข้อมูลการเขียนแบบ</b></h3>
                    <div class="row">
                    ...
                    <div class="row" style="margin-bottom: -5px;">
                      <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3">
                        ...
                        <div class="form-check" style="margin-bottom: 10px;">
                          <input class="form-check-input check-boxlg" type="checkbox" value="" id="status_toolnew">
                          <label class="form-check-label" for="status_toolnew">
                            สร้างใหม่ (New)
                          </label>
                        </div>
                        <div class="form-check" style="margin-bottom: 10px;">
                          <input class="form-check-input check-boxlg" type="checkbox" value="" id="status_regrind">
                          <label class="form-check-label" for="status_regrind">
                            ลับคมตัด (Re-grind)
                          </label>
                        </div>
                        <div class="form-check" style="margin-bottom: 10px;">
                          <input class="form-check-input check-boxlg" type="checkbox" value="" id="status_modify">
                          <label class="form-check-label" for="status_modify">
                            ดัดแปลงคมตัด (Modify)
                          </label>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                        <div class="input-group mb-3">
                          <span class="input-group-text ">Hardness(HB,HS,HRC...):</span>
                          <input type="text" class="form-control" id="data_phone" placeholder="" readonly>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                      <div class="col-sm-12 col-md-4 col-lg-2 col-xl-2">
                         <div class="form-check form-check-inline">
                          <input class="form-check-input check-boxlg" type="checkbox" id="status_drill" value="">
                          <label class="form-check-label" for="status_drill">เจาะ</label>
                        </div>
                      </div>
                      <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="input-group">
                          <span class="input-group-text ">ความลึกเจาะ</span>
                          <input type="text" class="form-control" id="depth_drill" placeholder="" readonly>
                        </div>
                      </div>
                      <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input check-boxlg" type="checkbox" id="inlineCheckbox1" value="option1">
                          <label class="form-check-label" for="inlineCheckbox1">ทะลุ</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input check-boxlg" type="checkbox" id="inlineCheckbox2" value="option2">
                          <label class="form-check-label" for="inlineCheckbox2">ไม่ทะลุ</label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row mt-2 align-items-center">
                      ...
                      <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="input-group">
                          <span class="input-group-text ">ความลึกกัดด้านข้าง</span>
                          <input type="text" class="form-control" id="depth_drill" placeholder="" readonly>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="input-group">
                          <span class="input-group-text ">ความลึกกัดด้านหน้า</span>
                          <input type="text" class="form-control" id="depth_drill" placeholder="" readonly>
                        </div>
                      </div>
