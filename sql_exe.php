...
// $sql_protect = 'cewkfewkfpewojkpojppjpejfp1fse,dgerg';
$sqlsreach = array();
...
// $sqlsreach['IND_ACTIVITYHD'] = "INSERT INTO activityhd (STATUS,DOCNO,CUST,CONT,CUSTNAME,CONTNAME,TEL,EMAIL,ADDR,LOCATION,SUBJECT,DETAIL,REF,PRIORITY,TIMED,TIMEH,TIMEM,STARTD,PRICECOST,PRICEPWITHDRAW,OWNER,OWNERNAME) VALUES (:STATUS,:DOCNO,:CUST,:CONT,:CUSTNAME,:CONTNAME,:TEL,:EMAIL,:ADDR,:LOCATION,:SUBJECT,:DETAIL,:REF,:PRIORITY,:TIMED,:TIMEH,:TIMEM,:STARTD,:PRICECOST,:PRICEPWITHDRAW,:OWNER,:OWNERNAME)";
...
//
$sqlsreach['EQUIPMENT'] = "INSERT INTO equipment (CREATED,ID, NAME, CODE, TYPE, MODEL, CUSTNAME, CONTNAME, PHONE, EMAIL, STATUS, DOCINFO, PRIORITY, MAINTENANCETIMES, BROKENTIMES, WARRANTY, PURCHASEDATE, FIRSTUSAGE, LASTUSAGE, DETAILS, RECORDERNO, RECORDERNAME, AREA, UPLOAD) VALUES (NOW(),:ID, :NAME, :CODE, :TYPE, :MODEL, :CUSTNAME, :CONTNAME, :PHONE, :EMAIL, :STATUS, :DOCINFO, :PRIORITY, :MAINTENANCETIMES, :BROKENTIMES, :WARRANTY, :PURCHASEDATE, :FIRSTUSAGE, :LASTUSAGE, :DETAILS, :RECORDERNO, :RECORDERNAME, :AREA, :UPLOAD)";
...
$sqlsreach['UPD_EQUIPMENT'] =  "UPDATE equipment SET NAME = :NAME, CODE = :CODE, TYPE = :TYPE, MODEL = :MODEL, CUSTNAME = :CUSTNAME, CONTNAME = :CONTNAME, PHONE = :PHONE, EMAIL = :EMAIL, STATUS = :STATUS, DOCINFO = :DOCINFO, PRIORITY = :PRIORITY, MAINTENANCETIMES = :MAINTENANCETIMES, BROKENTIMES = :BROKENTIMES, WARRANTY = :WARRANTY, PURCHASEDATE = :PURCHASEDATE, FIRSTUSAGE = :FIRSTUSAGE, LASTUSAGE = :LASTUSAGE, DETAILS = :DETAILS, RECORDERNO = :RECORDERNO, RECORDERNAME = :RECORDERNAME, AREA = :AREA, UPLOAD = :UPLOAD WHERE RECNO = :RECNO";
$sqlsreach['EQUIPMENT_LIST'] =  "SELECT RECNO,NAME,CODE  FROM equipment ORDER BY ID ASC";

$sqlsreach['SEL_NOTIMAINTEN'] = "SELECT * FROM notimainten";
$sqlsreach['IND_NOTIMAINTEN'] = "INSERT INTO notimainten (CREATED, ID, NAME, CONTNAME, EQUIPMENT, STATUS, PRIORITY, PRICECOST, PRICEPWITHDRAW, WARNINGDATE, DETAILS, RECORDERNO, RECORDERNAME) VALUES (NOW(), :ID, :NAME, :CONTNAME, :EQUIPMENT, :STATUS, :PRIORITY, :PRICECOST, :PRICEPWITHDRAW, :WARNINGDATE, :DETAILS, :RECORDERNO, :RECORDERNAME)";
