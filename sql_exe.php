...
// $sqlsreach['IND_EMPL'] = "INSERT INTO empl (LASTUPD, PERMISSION, STATUS, USERLEVEL, EMPNO, EMPNAME, EMPNAMEEN, EMPNICK, LOGIN, PASS, CREATED, IMG) VALUES (NOW() ,:PERMISSION ,:STATUS ,:USERLEVEL ,:EMPNO ,:EMPNAME ,:EMPNAMEEN ,:EMPNICK ,:LOGIN ,:PASS ,NOW() ,:IMG)";
