...
<header class="navbar navbar-expand-lg navbar-dark bg-custom sticky-top p-0 shadow ">
  ...
  <ul class="navbar-nav flex-row d-md-none">
    <li class="nav-item text-nowrap">
      <button class="navbar-toggler px-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="datatable_equipment.php">บักทึกอุปกรณ์</a></li>
          <li><a class="dropdown-item" href="datatable_warning.php">แจ้งซ่อม</a></li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="summaryproductdailyjob.php">ติดตามผลิต</a></li>
          <li><a class="dropdown-item" href="summaryproductclosedue.php">ผลิตใกล้ครบกำหนดส่ง</a></li>
          <li><a class="dropdown-item" href="summaryproductdiscontinue.php">ยังไม่เริ่มการผลิต</a></li>
          <li><a class="dropdown-item" href="summaryproductoverdue.php">เกินกำหนดส่งมอบ</a></li>
        </ul>
      </li>
