...
class ExcelGenerator
{
    ...
    public function generateExcel($filename)
    {
        ...
        // // ตั้งค่าส่งข้อมูลกลับเป็น JSON
        // header('Content-Type: application/json');

        // // ส่งอาเรย์เป็น JSON กลับไปยัง JavaScript
...
$queryId = NULL;
$data =  array();
$sqlQueries = new SQLQueriesExcel();
$sqlQuery = $sqlQueries->scanSQL($queryId);
// Get the data from the POST request

$filename = 'exported_data.xlsx';
$headMaker = new HeadMake();
$header = $headMaker->head($queryId);
