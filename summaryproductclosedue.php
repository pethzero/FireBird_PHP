  ...
  $(document).ready(function() {
    ...
    var tabledatahd = $('#table_datahd').DataTable({
      ...
      columns: [{
        ...
        },
        {
          ...
          render: function(data, type, row, meta) {
            if (data.ITEMNO == null) {
              ...
              return data.ITEMNO + "/" + data.MAXPROC + "(" + data.PROCCODE + ")";
        ...
        },
        {
          data: null,
          render: function(data, type, row, meta) {
            return convertToIntegerFix(data.QUANDONE, 'none');
          }
        },
        {
          data: null,
          render: function(data, type, row, meta) {
            return convertToIntegerFix(data.QUANBAD, 'none');
          }
        },
        {
          data: null,
          render: function(data, type, row, meta) {
            return convertToIntegerFix(data.QUANRET, 'none');
          }
        },
        {
          data: null,
        ...
        },
        {
          data: null,
          render: function(data, type, row, meta) {
            return convertToIntegerFix(data.QUANCLAIM, 'none');
          }
        },
        //  {data: 'QUANDONE', render:convertToInteger},
        //  {data: 'QUANBAD', render:convertToInteger},
        //  {data: 'QUANRET', render:convertToInteger},
        //  {data: 'QUANCLAIM', render:convertToInteger},
        {
          data: 'CUSTNAME',
        },
        {
    ...
    async function fecth_databased() {
      ...
      try {
        ...
        tabledatahd.clear().rows.add(jsonDataHD.datasql).draw();
