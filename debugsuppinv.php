                                            ...
                                            <div class="modal-dialog modal-sm modal-md modal-lg ">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="myModalLabel">ปรับใบแจ้งหนี้ <span id='story' class="badge"></span></h5>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                    <div class="input-group mb-3">
                                                                        <span class="input-group-text c_activity">เลขที่ใบแจ้งหนี้:</span>
                                                                        <input type="text" class="form-control" id="name" placeholder="หัวข้อเรื่อง" maxlength="255" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                            ...
                                                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                                <div class="input-group mb-3">
                                                                                    ...
                                                                                    <select class="form-select" id="status">
                                                                                        ...
                                                                                        <option value="P">ค้างชำระ</option>
                                                                                        <option value="C">ยกเลิก</option>
                                                                                        <option value="D">ชำระ</option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                        </div>
